...
def demo_buildinfunction():
    ...
    print 5, dir(list)     #查看list信息
    x = 2
    print 6, eval('x + 3')  #直接执行
    print 7, chr(65), ord('a') #assic 码 转化
    print 8, divmod(11, 3) #
    print 9,range(1,43,3)
...
def demo_random():
    ...
    random.shuffle(a)
    print 5, a
    print 6,random.randint(-100,100)
